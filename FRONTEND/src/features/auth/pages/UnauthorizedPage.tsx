        ...
        <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "#E8D5C0" }}>
            <div className="text-center">
                <div className="mb-6 flex justify-center">
                    <svg width="200" height="200" viewBox="0 0 24 24" fill="#C87A2E" style={{ opacity: 0.85 }}>
                ...
                <button
                    ...
                    className="bg-[#C87A2E] hover:bg-[#B06920] text-white font-bold px-6 py-3 rounded-xl transition-colors"
                >
                    Volver al login
                </button>
            </div>
