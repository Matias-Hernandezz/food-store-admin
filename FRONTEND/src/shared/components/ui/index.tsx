...
const variantStyles: Record<ButtonVariant, React.CSSProperties> = {
  primary: { backgroundColor: "#C87A2E", color: "#fff" },
  secondary: { backgroundColor: "#E5E2DA", color: "#2d1e0f" },
  danger: { backgroundColor: "#dc2626", color: "#fff" },
  ghost: { backgroundColor: "transparent", color: "#6b5a4e", border: "1px solid #E5E2DA" },
};
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <input
        ...
        style={{
          backgroundColor: "#fff",
          border: error ? "1px solid #dc2626" : "1px solid #E5E2DA",
          color: "#2d1e0f",
        }}
        {...props}
      />
...
export function Modal({ open, onClose, title, children }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: "rgba(0,0,0,0.5)", backdropFilter: "blur(4px)" }} onClick={onClose}>
      <div className="w-full max-w-lg rounded-2xl shadow-2xl" style={{ backgroundColor: "#fff", border: "1px solid #E5E2DA" }} onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: "1px solid #E5E2DA" }}>
...
const badgeStyles: Record<string, React.CSSProperties> = {
  default: { backgroundColor: "#E5E2DA", color: "#6b5a4e" },
...
export function SkeletonRow() {
  return (
    <div className="flex gap-4 px-4 py-3 animate-pulse">
      <div className="h-4 rounded w-1/4" style={{ backgroundColor: "#E5E2DA" }} />
      <div className="h-4 rounded w-1/3" style={{ backgroundColor: "#E5E2DA" }} />
      <div className="h-4 rounded w-1/5" style={{ backgroundColor: "#E5E2DA" }} />
    </div>
  );
}
...
export function ConfirmDialog({ open, message, onConfirm, onCancel, loading, confirmLabel = "Eliminar" }: ConfirmDialogProps) {
  return (
